...
services:
  sub2api:
    image: ghcr.io/zhjai/sub2api:latest
    ports:
      - "8080:8080"
    environment:
...
- [GitHub Repository](https://github.com/zhjai/sub2api-plus)
- [Documentation](https://github.com/zhjai/sub2api-plus#readme)
