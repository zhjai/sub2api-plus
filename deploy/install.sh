...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/zhjai/sub2api-plus/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="zhjai/sub2api-plus"
...
Documentation=https://github.com/zhjai/sub2api-plus
...
main() {
    ...
    case "${1:-}" in
        ...
        --help|-h)
            ...
            echo "  $0 install -v v0.2.7-zhjai.7  # Install specific fork version"
            echo "  $0 upgrade                # Upgrade to latest"
            echo "  $0 upgrade -v v0.2.7-zhjai.7  # Upgrade to specific fork version"
