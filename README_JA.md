...
- **🚫 商用サービスの非推奨**：この fork は第三者の商用サービスを運営または推奨するものではありません。適用されるライセンスは LGPL-3.0-or-later です。運用者は、このライセンスと利用する上流サービスの規約を自ら確認してください。
...
この fork は上流のスポンサー関係を主張または再掲しません。本リポジトリ向けに個別に承認されたものを除き、商業プロモーションは掲載しません。ツリー内のパートナーロゴは上流から引き継いだ履歴リソースであり、推薦やスポンサー声明を意味しません。
...
上流著作権: Copyright (c) 2026 Wesley Liddick and contributors.

Fork の変更部分: Copyright (c) 2026 zhjai/sub2api-plus contributors.
